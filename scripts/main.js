;(function (window) {
  ...
  let texts = ['HOLA C:', 'QUIERO ', 'QUE SEPAS', 'QUE ERES ', 'LO MEJOR', 'QUE ME ', 'HA PASADO', 'C:', 'NO PODRE', 'DARTE ROSAS', 'ESTE DIA', 'PERO ','TE ENVIO', 'ESTE','DETALLE','ESPERO QUE', ' TE GUSTE','RECUERDA', ' QUE', 'SIEMPRE','ESTAS','EN', 'MIS',' PENSAMIENTOS','FELIZ','DIA','DE','SAN','VALENTIN','TE',' LO','DESEA','SHAOPRO <3']
